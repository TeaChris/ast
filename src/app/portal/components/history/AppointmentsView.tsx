...
import { ChevronLeft, Search, Filter, Calendar as CalendarIcon } from 'lucide-react'
import { cn } from '@/lib/utils'
import CustomSelect from '../booking/CustomSelect'

const STATUS_OPTIONS = ['All Status', 'Confirmed', 'Pending', 'Cancelled']
const TYPE_OPTIONS = ['All Types', 'Academic Advising', 'Career Counseling', 'Math Tutoring']
  ...
  return (
    <div className="space-y-12 font-comfortaa pb-32">
      ...
      <div className="flex flex-col gap-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-[#0B0E14]">All Appointments</h1>
          <p className="text-[#6C757D] mt-1 text-base font-medium">View and manage all your appointments</p>
        </div>
      </div>
      ...
      <div className="bg-white border border-[#E9ECEF] rounded-[32px] p-8 shadow-sm">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h3 className="font-bold text-[#0B0E14] text-sm">Filters</h3>
        </div>
      ...
      <div className="bg-white border border-[#E9ECEF] rounded-[32px] p-10 shadow-sm min-h-[400px]">
        <div className="mb-10">
          ...
          <p className="text-[#6C757D] text-sm mt-1 font-medium">Your scheduled appointments that haven't occurred yet</p>
        </div>
