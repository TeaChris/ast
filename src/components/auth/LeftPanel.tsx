...
const Orb = ({
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 2.5 + delay * 0.5, ease: [0.16, 1, 0.3, 1], delay: delay * 0.3 }}
    />
  )
}
  ...
  return (
    <div
      ...
      style={{
        ...
        minHeight: '100vh',
        overflow: 'hidden',
        background: 'linear-gradient(135deg, #0A0A0C 0%, #111116 50%, #0d0d10 100%)',
        display: 'flex',
    ...
    >
      {/* Gradient orbs */}
      <Orb top="-10%" left="-15%" size={520} color="radial-gradient(circle, rgba(212,175,55,0.18) 0%, transparent 70%)" delay={0} />
      <Orb top="40%" left="55%" size={380} color="radial-gradient(circle, rgba(139,92,246,0.12) 0%, transparent 70%)" delay={1} />
      <Orb top="65%" left="-5%" size={300} color="radial-gradient(circle, rgba(212,175,55,0.1) 0%, transparent 70%)" delay={2} />
      ...
      <motion.div
        style={{ width: 48, height: 1, background: 'var(--gold)', marginBottom: '2rem', position: 'relative', zIndex: 10 }}
      ...
      >
        ...
        >
          ...
          <span
            style={{
              backgroundImage: 'linear-gradient(90deg, var(--gold-dim) 0%, var(--gold) 50%, var(--gold-dim) 100%)',
        ...
        >
          The intelligent scheduling layer for elite concierge practices. Automate, delight, and elevate every client touchpoint.
        </motion.p>
      ...
      >
        ...
        <div
          style={{
            ...
            height: 34,
            borderRadius: '10px',
            background: 'linear-gradient(135deg, var(--gold) 0%, rgba(212,175,55,0.5) 100%)',
            display: 'flex',
            alignItems: 'center',
        ...
        >
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            <circle cx="8" cy="8" r="5.5" stroke="#0A0A0C" strokeWidth="2" fill="none" />
            <circle cx="8" cy="8" r="2" fill="#0A0A0C" />
          </svg>
        </div>
        <span
          style={{
