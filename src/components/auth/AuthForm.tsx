...
export default function AuthForm({ initialMode = 'sign-in' }: AuthFormProps) {
      ...
      toast.error('All fields are required.', {
        icon: (
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            <circle cx="8" cy="8" r="7" stroke="#D4AF37" strokeWidth="1.5" />
            <path d="M8 4.5v4" stroke="#D4AF37" strokeWidth="1.5" strokeLinecap="round" />
            <circle cx="8" cy="11.5" r="0.75" fill="#D4AF37" />
          </svg>
        ),
        style: {
          background: '#111116',
  ...
  const enterVariant = direction === 1 ? slideVariants.enterRight : slideVariants.enterLeft
  const exitVariant = direction === 1 ? slideVariants.exitLeft : slideVariants.exitRight
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '0.5rem' }}>
        ...
        >
          {mode === 'sign-in' ? 'Welcome back' : 'Join Aura'}
        </motion.p>
      ...
      <div
        style={{
          height: '1px',
          background: 'linear-gradient(90deg, rgba(212,175,55,0.35) 0%, transparent 60%)',
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        <motion.button
          ...
          onMouseEnter={e => {
            if (!loading) (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 0 40px rgba(212,175,55,0.4)'
          }}
          onMouseLeave={e => {
            (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 0 24px rgba(212,175,55,0.22)'
          }}
        >
              ...
              >
                ...
                >
                  <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
                    <circle cx="7.5" cy="7.5" r="6" stroke="rgba(10,10,12,0.3)" strokeWidth="2" />
                    <path d="M7.5 1.5 a6 6 0 0 1 6 6" stroke="#0A0A0C" strokeWidth="2" strokeLinecap="round" />
                  </svg>
                </motion.span>
